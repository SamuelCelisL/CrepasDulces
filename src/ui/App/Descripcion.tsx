export default function Descripcion() {
    ...
    <div className="flex flex-col items-center flex-wrap bg-[#EFE6DE]" >
        ...
        <div className="flex flex-wrap flex-col md:flex-row sm:justify-center">
            <div className="m-4 p-2 shadow-lg rounded-4xl hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 bg-[#DCCBB3] hover:bg-[#9794f6] max-w-[250px]">
